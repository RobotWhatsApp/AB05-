...
let authFile = `${opts._[0] || 'session'}.akbar.json`
...
if (opts['test']) {
  ...
  conn.connect().then(() => {
 conn.sendMessage('6283890109310@c.us', 'Bot Telah Tersambung Ke Database Akbarbarz', 'conversation');
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai @user\n◪ Welcome in group:\n├─ @subject\n├─ Intro dulu\n├─ ❏ Nama: \n├─ ❏ Umur: \n├─ ❏ Asal kota: \n├─ ❏ Kelas: \n├─ ❏ Jenis kelamin: \nFOLLOW AKUN OWNER\n➣-\n➣https://youtube.com/channel/M.Akbar.B'
  conn.bye = 'Selamat Tinggal @user!\nTerimakasih Telah Bergabung Di Grup\n\nKalo Balik Jangan Lupa Bawa Duit Buat Anggota Disini'
